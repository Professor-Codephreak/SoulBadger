...
SoulBadger is a Solidity smart contract derived from erc-5484 to implement a Soulbound Token (SBT) system using the ERC721 NFT standard. Soulbound Tokens are non-transferable NFTs designed to represent permanent and unique user attributes. SoulBadger is  tailored for deployment and testing using Foundry providing user profiles and strict transfer restrictions. SoulBadger is a SoulBound Badge creation NFT contract with eight slots for identity characteristics.
